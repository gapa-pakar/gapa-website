                                ...
                                testimonialData.map(({ id, name, text, img }) => {
                                    return (
                                        <div key={id} className='my-6'>
                                            <div className='flex flex-col sm:flex-row gap-5 md:gap-40 p-4 mx-5 rounded-xl dark:bg-gray-800 relative'>
                                                <img src={img} alt='' className='block mx-auto sm:h-[300px] w-full xl:w-[600px] object-cover'/>
                                                <div className='space-y-4 m-5'>
                                                    <p className='font-bold text-direction'>{text}</p>
                                                    <h1 className='text-gray-500 text-black/80 dark:text-white/80 x:pr-40'>{name}</h1>
                                                </div>
